...
class LoginInstituicao extends Component {
    ...
    login = async () => {
        ...
        try {
          if (email === "" || senha === "") {
            ...
            .then(() => this.props.navigation.navigate("HomeInstituicao")
            )
            .catch((error) => {
            ...
            <Container>
                <ScrollView style={styles.scroll}>
                    <Header androidStatusBarColor={'grey'} style={{ backgroundColor: '#0069cc' }}>
                        ...
                        <Text style={styles.txtCab}>Login Instituição</Text>
                    ...
                    <View style={styles.container}>
                        ...
                        <Button style={styles.btnCadastrar} onPress={() => this.props.navigation.navigate('CadastroInstituicao')}>
